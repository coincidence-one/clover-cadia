...
export const ROUNDS: RoundConfig[] = [
  ...
  { round: 1, goal: 150, maxSpins: 10, rewardTickets: 1 },  // Goal > 100 Initial Credits
  { round: 2, goal: 300, maxSpins: 12, rewardTickets: 1 },
  { round: 3, goal: 500, maxSpins: 15, rewardTickets: 2 },

  // Mid-game
  { round: 4, goal: 800, maxSpins: 20, rewardTickets: 2 },
  { round: 5, goal: 1200, maxSpins: 25, rewardTickets: 2 },
  { round: 6, goal: 1800, maxSpins: 30, rewardTickets: 3 },

  // Late-game (Challenging)
  { round: 7, goal: 2600, maxSpins: 35, rewardTickets: 3 },
  { round: 8, goal: 4000, maxSpins: 40, rewardTickets: 4 },
  { round: 9, goal: 6000, maxSpins: 45, rewardTickets: 4 },
